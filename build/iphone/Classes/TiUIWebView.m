...
static NSString * const kOCR_AppJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_ocr_appInjection
{
	...
	[html appendString:kOCR_AppJavascript];
...
{
	// attempt to make well-formed HTML and inject in our OCR_App bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _ocr_appInjection]];
