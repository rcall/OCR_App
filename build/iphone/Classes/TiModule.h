...
/**
 The base class for all OCR_App modules
 */
...
/**
 OCR_App Platform calls this method on startup.
 */
-(void)startup;

/**
 OCR_App Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 OCR_App Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 OCR_App Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 OCR_App Platform calls this method on resume.
 @param sender The sender of the event.
 */
