 ...
 * Copyright (c) 2009-2011 by OCR_App, Inc. All Rights Reserved.
...
//@interface OCR_AppObject : NSObject
//@end

@interface OCR_AppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[OCR_AppObject class]])
		{
			for (NSString *key in [[(OCR_AppObject*)o modules] allKeys])
			{
