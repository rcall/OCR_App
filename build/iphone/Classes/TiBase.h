...
// in simulator we redefine to format for OCR_App Developer console
...
{\
	NSString * exceptionName = [@"org.ocr_app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ocr_app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIOCR_AppNativeItemNone = -1, 
	UIOCR_AppNativeItemSpinner = -2,
	UIOCR_AppNativeItemProgressBar = -3,
	
	UIOCR_AppNativeItemSlider = -4,
	UIOCR_AppNativeItemSwitch = -5,
	UIOCR_AppNativeItemMultiButton = -6,
	UIOCR_AppNativeItemSegmented = -7,
	
	UIOCR_AppNativeItemTextView = -8,
	UIOCR_AppNativeItemTextField = -9,
	UIOCR_AppNativeItemSearchBar = -10,
	
	UIOCR_AppNativeItemPicker = -11,
	UIOCR_AppNativeItemDatePicker = -12,
	
	UIOCR_AppNativeItemInfoLight = -13,
	UIOCR_AppNativeItemInfoDark = -14,
	
	UIOCR_AppNativeItemDisclosure = -15,
	
	UIOCR_AppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all OCR_App instances of
