...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by gamesquad",
		deployType: "development",
		description: "not specified",
		guid: "9d0b4af3-2e79-433b-b4e8-705f19290339",
		id: "com.hackucla.ocr.app",
		name: "OCR_App",
		names: {},
		publisher: "gamesquad",
		url: "http://",
...
p.setString("acs-api-key-production","fZyfKas7zIj0NH0OJvZJutms7PxW7bFK");
p.setString("acs-api-key-development","mVfMtsSVYR4k1rKwOlpT0Oz2ARXnaLU6");
p.setString("acs-oauth-secret-development","Xz5dioStM7fmIu4Qkd1ZkhnN20vaeacW");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","jtA8wq9B9B8mM2HRacRoaySoggsERS2U");
p.setString("acs-oauth-key-development","dUjwvs0vYbsQVdYdnMqNrsM220J90Vq0");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","ssb8AOIxXNGyMuQXzb88rPRY5t6EiYvq");
});
